...
window.addEventListener("__FENGARI_DEVTOOLS_REGISTER_RESOURCE__", function (event) {
    chrome.extension.sendMessage({
        type: "__FENGARI_DEVTOOLS_REGISTER_RESOURCE__",
        data: event.detail
    });
});
...
window.addEventListener("__FENGARI_DEVTOOLS_DEBUG_RESOURCE__", function (event) {
    chrome.extension.sendMessage({
        type: "__FENGARI_DEVTOOLS_DEBUG_RESOURCE__",
        data: event.detail
    });
});
